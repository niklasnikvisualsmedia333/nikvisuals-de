...
import {Home} from './pages/Home'; import {Links} from './pages/Links'; import {Videos} from './pages/Videos'; import {MediaConsentProvider} from './components/MediaConsent'; import './styles/global.css';
...
const pageApp=page==='links'?<Links lang={lang}/>:page==='videos'?<Videos lang={lang}/>:<Home lang={lang}/>;
